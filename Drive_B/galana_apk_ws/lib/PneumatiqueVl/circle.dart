  ...
  Future fetchData() async {
    if(iSPneumatiqueVl == true) {
      ...
      if (connectivityResult != ConnectivityResult.none) {
        var url =
        Uri.parse('$urlServer/PNEUMATIQUE/GALANAvl/148.php?ApiKey=SDGDKWXDHT45D4D&temp_pneumatique');
      ...
      children: [
        AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            if (dataVl == 'VL libre' || dataVl == '') {
              damnColor = Colors.blue; // Change color to blue if data is 'VL libre'
            }
            return Container(
        ...
        if (!isLoadingVl && dataVl != 'VL libre')
          Positioned(
            bottom: 20.0,
            right: 0,
